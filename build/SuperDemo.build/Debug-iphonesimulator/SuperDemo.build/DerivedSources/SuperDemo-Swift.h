...
SWIFT_CLASS("_TtC9SuperDemo11AppDelegate")
...
@property (nonatomic, strong) NSIndexPath * __null_unspecified select;
...
@property (nonatomic, strong) UISearchController * __nonnull searchView;
